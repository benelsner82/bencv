...
tribble(
  ...
  "Irish Research Council", "2023", "Government of Ireland Postgraduate Scholarship", "Co-PI with Dimitrios Argyros, 55,000€",   
...
## 2015
IZA Workshop "Inequality: Causes and Consequences" (Bonn), SOLE/EALE World Congress (Montreal), Workshop Health.Skills.Education (Essen), IZA/Worldbank Conference on Employment and Development (Bonn), EEA Meeting (Mannheim), Verein f\"{u}r Socialpolitik (M\"{u}nster), Workshop "Immigration in OECD Countries" (Paris)
...
YouTube Channel with over 70 videos, over 50k views, over 2,000 subscribers
...
Causal Research Designs with DAGs (\"{O}rebro University, 2022)
